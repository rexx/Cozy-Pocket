...
- 優先對象包含 `SettingsPage`、`SyncStatusPage`、`SearchPage`、`MonthlyStatsPage`、`MerchantManagementPage`、`AddTransactionModal`。
...
- 手動驗證設定、同步狀態、搜尋、月統計、商家管理與交易 modal 的首次開啟與返回流程正常。
