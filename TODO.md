...
- 🟡 把 Tag 更名的按鈕顯示邏輯對齊商家更名：預設只顯示預覽按鈕，按下預覽後才在下方出現黃色預覽匡與確認按鈕，並補上確認送出中的旋轉 icon。（計劃：[tag-rename-confirm-alignment.md](docs/todo-references/tag-rename-confirm-alignment.md)）
